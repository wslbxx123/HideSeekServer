...
//					alert(JSON.stringify(result));
	...
	$(".photo").error(function(){
		$(this).attr("src","__PUBLIC__/Image/Web/mypicture.png");	
	}); 
					...
					case "10000":
						...
						for(var i = 0;i < result.result.products.length;i++){	
							...
							var purArea = document.getElementById("purArea");
						  	...
						  	messageImg.src = "__PUBLIC__/Image/Web/score.png";
						  	...
						  	peopleImg.src = "__PUBLIC__/Image/Web/people.png";
					...
					case "10000":
						...
						for(var i = 0;i < result.result.reward.length;i++){	
							...
							var exArea = document.getElementById("exArea");
						  	...
						  	//商品兑换信息框：商品积分图标
						  	var messageImg = document.createElement('img');
						  	messageImg.src = "__PUBLIC__/Image/Web/score1.png";
						  	messageImg.className = "scoreImg";
						  	messageDiv.appendChild(messageImg);
					...
					switch(result["code"]){
						case "10000":
							...
							if(result["result"]["photo_url"]==null){
								document.getElementById("myimg").src = "__PUBLIC__/Image/Web/mypicture.png";
							}
							else{
